...
<div class="body d-flex justify-content-between align-items-center">
    ...
    <a href="../page/SaranKritikPage.php" class="btn btn-success">Tambah</a>
                    ...
                    <div class="card-body ">
                        <div class="flex-between mb-2">
                            ...
                            <div class="text-nowrap">
                                <a href="../page/EditKritikSaranPage.php?id=<?php echo $data['id']; ?>" class="btn btn-light"><img src="../assets/images/mc-icons/diamond_pickaxe.png" class="mc-icon" style="height: 30px;"></a>
