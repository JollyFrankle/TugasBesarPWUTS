...
<div class="text-center mb-3">
    <a href="./TambahReservasi.php" class="btn btn-dark btn-lg">
...
<div class="table-responsive" style="margin-bottom:15vw;">
    <table class="table table-hover rounded rounded-1 overflow-hidden align-middle">
        ...
        <tbody class="table-group-divider">
            ...
            $sql = "SELECT *, rev.id AS id_reservasi, IF(rev.tanggal < ?, 1, 0) AS sudah_lewat FROM reservasi_ruang_baca rev
            JOIN ruang_baca rb ON (rev.id_ruang = rb.id)
            JOIN users u ON (rev.id_user = u.id)
            WHERE rev.id_user = ?
            ORDER BY sudah_lewat ASC, tanggal ASC, sesi ASC, id_ruang ASC;";
