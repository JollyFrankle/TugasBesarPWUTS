...
<div class="row" style="margin-bottom:15vw;">
    <form class="col-lg-8 col-xl-6 mb-3 needs-validation" id="form-kritsar" method="POST" action="../../process/addEditSaranKritik.php">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" name="konten" id="konten" rows="5" placeholder="Masukkan Kritik/Saran" maxlength="255" required><?php echo $kritik_saran ['konten'] ?></textarea>
            <div class="invalid-feedback">
